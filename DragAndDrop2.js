...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/DMH_35_00_digital_display_numbers_SFS_dashes.png?1460999423359", id:"DMH_35_00_digital_display_numbers_SFS_dashes"},
		{src:"images/DMH_35_02_roasted_chicken.png?1460999423359", id:"DMH_35_02_roasted_chicken"},
		{src:"images/DMH_35_thermistor_alone.png?1460999423359", id:"DMH_35_thermistor_alone"},
		{src:"images/DMH_35_thermistor_buttons_.png?1460999423359", id:"DMH_35_thermistor_buttons_"}
	]
};
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{Scene2:0,"Drag Func":16});
	...
	this.frame_16 = function() {
		  ...
		  dragger.on("pressup", function(evt){  //this function will be very custom, always
		    ...
		    if(hitTestArray.length > 1){
		      ...
		      stage.update(evt);
		        ...
		        if(intersect(tip, right)){    //Intersection testing for good
		...
		function intersect(rect1, rect2, x, y) {
	...
	this.targetRight.setTransform(269.7,235.7,0.536,0.443,0,0,0,137.5,150);
	...
	this.targetWrong.setTransform(367.9,288.7,0.891,0.578,0,0,0,206.5,215);
